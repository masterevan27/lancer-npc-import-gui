...
const SETTINGS_GROUPS = [
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'generateBackgroundScript', type: 'path', derived: 'generateBackgroundScript', label: 'generate-background.py' },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'secretTablesDir', type: 'path', derived: 'secretTablesDir', label: 'Secret tables folder',
                help: 'Your own .json or .md roll tables, offered on Create NPC in Secret mode.' },
            { key: 'secretPromptsDir', type: 'path', derived: 'secretPromptsDir', label: 'Secret prompts folder',
                help: 'Your own .md secret prompt templates, offered on Create NPC in Secret mode.' },
        ],
    },
    {
        id: 'spaceship',
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'dynamicBackgroundTablesPath', type: 'path', derived: 'dynamicBackgroundTablesPath', label: 'Dynamic background tables' },
            { key: 'backgroundPresetsDir', type: 'path', derived: 'backgroundPresetsDir', label: 'Background table presets' },
        ],
    },
    {
        id: 'advanced',
