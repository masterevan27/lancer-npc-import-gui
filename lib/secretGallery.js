...
function createGallery({ config, configFile, paths, artStylesPath, workflowCatalog = require('./workflows').createCatalog(path.dirname(paths.generateNpcScript)), rerollableFor = () => [] }) {
    const jobs = new Map();
