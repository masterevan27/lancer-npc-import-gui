 ...
 * entirely. The GUI only ever needs ids and names (the prompt text stays
 * server-side, as with art styles), plus the saved `color_guidance` metadata
 * a manifest record carries.
 */
