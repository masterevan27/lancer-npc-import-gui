...
Expect every discovered test to pass. The exact count changes whenever coverage
is added. No install step; the suite spawns real `server.js` child processes against synthetic fixture
...
Ports 5193–5199, 5201–5234, 5236–5242, 5245 and 5251–5255 are taken. The
last two ranges include the expression API, panel, migration and kind-race tests.
...
with no tests in it. Expect one more discovered file there for a helper that
declares no tests and therefore cannot fail.
